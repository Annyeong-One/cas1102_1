...
void print_array(const int* arr, int size) {
    ...
    // START TODO BLOCK #1
    for (int i=0; i<size; i++){ // TODO: 1. Use a 'for' loop to iterate through the array.
        std::cout << *(arr + i); // TODO: 2. Access and print the element at index 'i' using only pointer arithmetic: *(arr + i)
        if (i != size - 1) {
            std::cout << ", "; // TODO: 3. Add ", " after the element unless it is the last element.
        }
    }
    // END TODO BLOCK #1
...
void swap_values(int& a, int& b) {
    ...
    int temp=a;
    a=b;
    b=temp; // TODO: Use a temporary variable to correctly swap the values of 'a' and 'b'.
    // END TODO BLOCK #2
}
